...
const Introduction = () => {
  return (
    <div className="introduction space-y-8">
      <h1 className="text-5xl font-extrabold mb-6">Introduction</h1>

      <section id="what-is-nexuspay" className="space-y-4 mb-8">
        <h2 className="text-4xl font-bold">What is NexusPay?</h2>
      ...
      <section id="how-to-use" className="space-y-4 mb-8">
        <h2 className="text-4xl font-bold">How to Use This Documentation</h2>
