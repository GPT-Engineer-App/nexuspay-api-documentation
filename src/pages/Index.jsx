...
const Index = () => {
  return (
    <div className="text-center">
      <img src="https://marcroland84.wordpress.com/wp-content/uploads/2024/07/img_7181-1.png?w=510" alt="NexusPay Logo" className="mx-auto mb-8 h-32 w-32 object-contain" />
